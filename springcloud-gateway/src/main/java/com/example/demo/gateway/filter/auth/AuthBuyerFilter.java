...
public class AuthBuyerFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        ...
        if("/api/order/order/create".equals(request.getRequestURI())){
            return true;
        }
        return false;
    }
    ...
    /**
     * /order/create 买家下单 只能买家访问 （cookie里有X-Token，value是token_uuid_usertype, usertype是BUYER，把value当key去redis里拿token）
     * ***/
    ...
    public Object run() throws ZuulException {
        ...
        if(cookie == null || StringUtils.isEmpty(cookie.getValue())){
            ...
            if(StringUtils.isBlank(userInfoJson)){
                ...
                if(!userInfoDTO.getRole().equals(RoleEnum.BUYER.getType())){
